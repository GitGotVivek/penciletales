            ...
            <div className="py-12 bg-gray-100">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <section className="mb-12">
                        <Typography variant="h2" className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4 text-center">
                            About Our Blog
                        </Typography>
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <img
                                ...
                                alt="Demo 1"
                                className="w-full sm:w-1/2 md:w-1/3 rounded-lg shadow-lg"
                            />
                            <img
                                src="https://via.placeholder.com/300x200"
                                alt="Demo 1"
                    ...
                    {/* Cards Section */}
                    <section>
                        <Typography variant="h2" className="text-xl sm:text-2xl font-bold text-gray-800 mb-6 text-center">
                            What We Offer
                        </Typography>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            <Card className="p-6 shadow-lg rounded-lg bg-white">
                                <Typography variant="h4" className="text-lg sm:text-xl font-semibold mb-4">Latest Articles</Typography>
                            ...
                            <Card className="p-6 shadow-lg rounded-lg bg-white">
                                <Typography variant="h4" className="text-lg sm:text-xl font-semibold mb-4">Expert Reviews</Typography>
                                <Typography variant="body1" className="text-gray-700">
                            ...
                            <Card className="p-6 shadow-lg rounded-lg bg-white">
                                <Typography variant="h4" className="text-lg sm:text-xl font-semibold mb-4">Community Discussions</Typography>
                                <Typography variant="body1" className="text-gray-700">
